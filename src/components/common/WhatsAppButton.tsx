...
export function WhatsAppButton({ whatsappNumber, message = "Hi Ruvaya! I have a question about" }: WhatsAppButtonProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-[84px] right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-success text-white shadow-lg transition-transform hover:scale-105 sm:bottom-6 sm:right-6"
    >
